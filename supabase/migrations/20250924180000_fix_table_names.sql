...
-- The code expects lowercase table names but some migrations created quoted names

-- Drop existing tables if they exist (with quotes)
DROP TABLE IF EXISTS "Message" CASCADE;
DROP TABLE IF EXISTS "Recipient" CASCADE;
DROP TABLE IF EXISTS "DmsConfig" CASCADE;
DROP TABLE IF EXISTS "DmsCycle" CASCADE;

-- Create tables with correct lowercase names that match the code expectations
