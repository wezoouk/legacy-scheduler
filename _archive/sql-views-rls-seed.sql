-- SQL Views with RLS Policies and Seed Data
...
-- 8. Seed data for development (replace {{AUTH_USER_ID}} with actual UUID)
...
INSERT INTO "Message" (
  ...
  gen_random_uuid(),
  '3f4cfbeb-5515-4b84-a130-4428c00b1e40',
  'NORMAL',
  ARRAY['EMAIL'],
  'Welcome to Legacy Scheduler',
  'This is a sample message to get you started with the Legacy Scheduler system.',
  'DRAFT',
  NULL,
